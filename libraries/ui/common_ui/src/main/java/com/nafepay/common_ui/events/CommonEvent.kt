package com.nafepay.common_ui.events
...
sealed class CommonEvent {
    ...
    object NavigateToWebView  : CommonEvent()
    data class ChangeImagePreview(val previewUri: Uri?) : CommonEvent()
    data class ChangeWebViewUrl(val uri: String) : CommonEvent()
