...
val NafepayPurple = Color(0xFF850284)
val NafepayBlue = Color(0xFF044B95)
val NafepayYellow = Color(0x66FDFA26)
...
val DarkThemeBarsBlack = Color(0xFF272727)

val DarkThemeBlack = Color(0xFF000000)
