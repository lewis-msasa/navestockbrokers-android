package com.nafepay.domain.remote.ktor

import android.util.Log
import com.google.gson.Gson
import com.nafepay.domain.exceptions.ExceptionHandler
                           ...
                           in 300..399 -> {
                               ...
                               if (responseBody.isNotEmpty() && responseBody.contains(
                                   ...
                                   val error = gson.fromJson(
                                       responseBody,
                                       com.nafepay.domain.models.authentication.registration.Error::class.java
                                   )
                   ...
                   handleResponseExceptionWithRequest { exception, httpRequest ->
                       ...
                       val error = when (httpRequest) {
                           ...
                           //or do whatever you need
                               ...
                               ExceptionHandler.getError(response)
                           }
                       }
